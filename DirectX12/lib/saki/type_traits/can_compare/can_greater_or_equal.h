/**
* @file can_greater_or_equal.h
* @brief 指定した型が(>=)演算子を使用できるかどうか判定するメタ関数
* @author 石山 悠
* @date 2019/01/22
*/
#pragma once
#ifndef SAKI_TYPE_TRAITS_CAN_COMPARE_CAN_GREATER_OR_EQUAL_2019_01_22
#define SAKI_TYPE_TRAITS_CAN_COMPARE_CAN_GREATER_OR_EQUAL_2019_01_22
#include <type_traits>
#include <utility>
...
#endif //SAKI_TYPE_TRAITS_CAN_COMPARE_CAN_GREATER_OR_EQUAL_2019_01_22