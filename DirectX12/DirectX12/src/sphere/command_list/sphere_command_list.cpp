/**
* @file sphere_command_list.cpp
* @brief スフィア用のコマンドリストクラスの関数を定義
* @author 石山　悠
* @date 2019/03/12
*/
#include "sphere_command_list.h"
#include "../../device/device.h"
#include "../../common/message_box.h"
#include "../../shader/shader.h"

/**
* @brief スフィア用のパイプラインを作成
* @return 成功したかどうか
*/
HRESULT SphereCommandList::CreatePipeline()
{
	HRESULT hr = S_OK;
	...
	if (FAILED(hr))
	{
		Comment(L"グラフィックスパイプラインステートの作成に失敗",
			L"sphere_command_list.cpp/SphereCommandList::CreatePipeline");
		return hr;
	}
